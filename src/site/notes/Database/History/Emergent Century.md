---
{"dg-publish":true,"permalink":"/database/history/emergent-century/","tags":[null],"dgShowInlineTitle":true,"noteIcon":"","updated":"2026-09-18T22:35:38.320-04:00","dg-note-properties":{"tags":[null]}}
---


> [!timeline|no-icon no-icon bg-c-gray ttl-c]+ The Hive Emerges
>
>> [!|no-icon bg-c-gray]+ EC 0072
...
>> 
> 
>> [!|no-icon bg-c-gray]+ EC 0078 - 0081 - Fighting Over Scraps
...
>> 
>> And all this amidst the worst refugee crisis in the history of civilization.
>
>> [!|no-icon bg-c-gray]+ EC 0081 - The Ceres Accords
>>The war *officially* ends in a truce and an armistice rather than a surrender. Unofficially, it's a stalemate that still heavily favors the [[Database/Factions/Jovian Consortium\|Jovian Consortium]]. [[Database/Factions/Apsis\|Apsis]] is established on [[Database/Places/Colonies/Ceres\|Ceres]] as an ostensibly-neutral body under the oversight of stellar shipping magnate [[Database/People/The Man Upstairs\|The Man Upstairs]].

>[!TIMELINE| no-icon bg-c-gray ttl-c]+ Here We Go Again
>
>> [!|no-icon bg-c-gray]+ 2 Feb 0092
>> Eleven years since the Accords, Apsis are all-but-openly anything but neutral. An Apsis reallocation cuts rations to the colonies of [[Database/Places/Colonies/Kelly\|Kelly]], [[Database/Places/Colonies/Arjuna\|Arjuna]], and [[Database/Places/Colonies/Geb\|Geb]] below starvation levels, as retaliation for increasingly serious demonstration against Apsis's restrictions.
>
>> [!|no-icon bg-c-gray]+ 15 Mar 0092
>> Apsis intended to make an example of the colonies. Instead, they trigger open, armed revolt. The [[Database/Factions/Rebels\|Rebels]] announce their existence by raiding a [[Database/Places/Jupiter Sphere/Jupiter\|Jupiter]]-bound freighter and redistributing its cargo at gunpoint. 
>
>> [!|no-icon bg-c-gray]+ Spring & Summer 0092
>>  The [[Database/Factions/Rebels\|Rebels]] emerge as a semi-unified, cell-based guerilla force made of [[Database/Factions/Armada Ejecta\|Armada Ejecta]], [[Database/Factions/Jovian Consortium\|Jovian Consortium]] defectors, [[Database/Factions/Republic Of Mars\|Martian]] militants, and civilians who are taking the opportunity to join up and actually fight for change. The young rebellion is receiving a surprising amount of under-the-table backing from within the political establishment, and significant open backing from those Belt colonies they're able to reliably defend.

>[!TIMELINE|no-icon no-fancy bg-c-gray ttl-c]+ CAMPAIGN START

---
{"dg-publish":true,"permalink":"/database/history/emergent-century/","tags":[null],"dgShowInlineTitle":true,"noteIcon":"","updated":"2026-09-18T22:01:55.402-04:00","dg-note-properties":{"tags":[null]}}
---


> [!timeline|no-icon no-icon no-fancy bg-c-gray ttl-c] The Hive Emerges
>
>> [!metadata|no-icon bg-c-gray] EC 0072
>> Fungal infection first takes root in wheat exports. First infectees report strange symptoms. 
>
>> [!metadata|no-icon bg-c-gray] EC 0073 - EC 0075
...
>
>> [!metadata|no-icon bg-c-gray] EC 0076
...
>[!TIMELINE|no-icon no-fancy bg-c-gray ttl-c] **[[Database/History/The Ground War\|The Ground War]]**
>
>> [!metadata|no-icon bg-c-gray] EC 0078 - MOONDROP
...
> 
>> [!metadata|no-icon bg-c-gray] EC 0078 - 0081 - FIGHTING OVER SCRAPS
...
>
>>[!metadata|no-icon bg-c-gray] EC 0081 - THE CERES ACCORDS
...
>[!TIMELINE| no-icon no-fancy bg-c-gray ttl-c] Here We Go Again
>
>> [!metadata|no-icon bg-c-gray] EC 0092
...
>> 
>> Apsis intended to make an example of the colonies. Instead, they trigger open, armed revolt. The [[Database/Factions/Rebels\|Rebels]] emerge as a semi-unified, cell-based guerilla force made of [[Database/Factions/Armada Ejecta\|Armada Ejecta]], [[Database/Factions/Jovian Consortium\|Jovian Consortium]] defectors, [[Database/Factions/Republic Of Mars\|Martian]] militants, and civilians who are taking the opportunity to join up and actually fight for change. The young rebellion is receiving a surprising amount of under-the-table backing from within the political establishment, and significant open backing from those Belt colonies they're able to reliably defend.

...
>>
>>> [!infobox|collapse txt-c]
>>> **`=link(this.Attending[3], this.Attending[3].file.aliases[0])`**
>>> `=embed(link(this.Attending[3].Portrait, "cover htiny"))`
>
> ## Appearing
>  | NPCs                                      |
> | ----------------------------------------- |
...
> | [[Database/Factions/UT-F-08S Hoplite Striker\|UT-F-08S Hoplite Striker]] |
> 
{ .block-language-dataview}
>  | Locations                                 |
> | ----------------------------------------- |

---
{"dg-publish":true,"permalink":"/rules/6-running-the-game/","tags":["rules","chapter"],"dgShowInlineTitle":true,"dgShowToc":true,"noteIcon":"","updated":"2026-06-27T10:31:21.924-04:00","dg-note-properties":{"tags":["rules","chapter"]}}
---

Welcome to the GM guide, make yourself at home!

If you're already comfortable running fiction-first RPGs and don't feel like going through one amateur designer's extended manifesto, then just read the [[Rules/6 Running The Game#Running This Game\|#Running This Game]] section and then be off on your merry way to your game table. Most of this game's rules are player-facing, but there's still a few things in there that you'll need to internalize if you want the intended experience.
...
If that sounds like something worth reading, then once you're finished the Running This Game section, move along to [[Rules/6 Running The Game#You Are Not A Storyteller\|#You Are Not A Storyteller]].
...
If you want advice on *performing* your NPCs, see [[Rules/6 Running The Game#The Seven Dwarfs Method\|#The Seven Dwarfs Method]] and [[Rules/6 Running The Game#Optional 3-Axis Acting\|Optional: 3-Axis Acting]] in the universal guidance section later on. 
...
The [[Rules/1 Core Rules#Declaring a Story Detail\|1 Core Rules#Declaring a Story Detail]] section of Core Rules outlines the guidance for when to allow the use of that option and when to veto it. Below, you'll find a more detailed extended example that didn't fit into what was supposed to be the go-to mid-session lookup document.
 > [!callout|bg-red c-plain no-icon ]+ EXAMPLE: PRINCE NAVIN OF BHOGURA
...
If you want to further distinguish this NPC, go to [[Rules/6 Running The Game#Optional 3-Axis Acting\|#Optional 3-Axis Acting]].
...
If there's no uncertainty for the mechanics to resolve, proceed to [[Rules/6 Running The Game#What Follows the Result\|#What Follows the Result]]. Otherwise, follow the appropriate rules for whatever's happening, then move on to the next question.

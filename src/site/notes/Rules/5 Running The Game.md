---
{"dg-publish":true,"permalink":"/rules/5-running-the-game/","tags":["rules","chapter"],"dgShowInlineTitle":true,"dgShowToc":true,"noteIcon":"","updated":"2026-08-23T15:57:42.771-04:00","dg-note-properties":{"tags":["rules","chapter"]}}
---
...
If you're already comfortable running fiction-first RPGs and don't feel like going through one amateur designer's extended manifesto, then just read this chapter and then be off on your merry way to your game table. Most of this game's rules are player-facing, but there's still a few things in there that you'll need to internalize if you want the intended experience.

If you're an inexperienced or first-time GM looking for advice on running RPGs in general, you like the design of this game enough that you want to see more of the philosophy that informed it, or you're just morbidly curious, you'll also want to read next chapter,, [[Rules/7 General GM Guidance\|7 General GM Guidance]].
...
If you want advice on *performing* your NPCs, see [[Rules/5 Running The Game#The Seven Dwarfs Method\|#The Seven Dwarfs Method]] and [[Rules/5 Running The Game#Optional 3-Axis Acting\|Optional: 3-Axis Acting]] in the universal guidance section later on. 
...
Weird NPCs can have whatever combination of aspects, skills, approaches, stunts, strain, and consequences you feel it takes to make them appropriately relevant (typically this translates to "dangerous", but not always). Break the rules. When you determine their stats, focus your attention more on how this "NPC" might create interesting decisions for the PCs than on strict conceptual accuracy. 

If your game uses recurring grunt mechs, you might consider treating those mechs as weird NPC templates attached to throwaway NPC pilots.

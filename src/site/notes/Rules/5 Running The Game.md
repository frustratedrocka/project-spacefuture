---
{"dg-publish":true,"permalink":"/rules/5-running-the-game/","tags":["rules"],"noteIcon":"","updated":"2026-06-24T19:06:20.733-04:00","dg-note-properties":{"tags":["rules"]}}
---

Welcome to the GM guide, make yourself at home!

If you're already comfortable running fiction-first RPGs and don't feel like going through one amateur designer's extended manifesto, then just read the [[Rules/5 Running The Game#Running This Game\|#Running This Game]] section and then be off on your merry way to your game table. Most of this game's rules are player-facing, but there's still a few things in there that you'll need to internalize if you want the intended experience.
...
If there's no uncertainty for the mechanics to resolve, proceed to [[Rules/5 Running The Game#What Follows the Result\|#What Follows the Result]]. Otherwise, follow the appropriate rules for whatever's happening, then move on to the next question.

---
{"dg-publish":true,"permalink":"/rules/1-core-rules/","tags":["rules","chapter"],"dgShowInlineTitle":true,"dgShowToc":true,"noteIcon":"","updated":"2026-06-27T12:58:09.000-04:00","dg-note-properties":{"tags":["rules","chapter"]}}
---
...
**ADD** the number for your **[[Rules/3 Skills, Approaches, & Stunts#Skills\|SKILL]]** and the number for your **[[Rules/3 Skills, Approaches, & Stunts#ApproachES\|APPROACH]]** to determine the size of your **DICE POOL**, then roll that many **TEN-SIDED DICE (d10)**. Each die that comes up 8 or higher counts as a **HIT**. Each result of 10 counts as 2 hits; each result of 1 subtracts a hit. 

---
{"dg-publish":true,"permalink":"/rules/7-general-gm-guidance/","tags":["rules","chapter"],"dgShowInlineTitle":true,"dgShowToc":true,"noteIcon":"","updated":"2026-06-29T03:56:30.000-04:00","dg-note-properties":{"tags":["rules","chapter"]}}
---
...
If all else fails, there's only really one thing about running RPGs that you must always remember:
...
- Things that have already happened and things that could happen
- Things that are definitely true and things that are only provisionally true
- Characters in the scene, characters not in the scene but who are relevant to it, and characters waiting in the wings
- Ticking clocks counting down to something that will interrupt a scene and turn everything in it on its head
...
A prepared situation is flexible and resilient in ways that a planned sequence can't be. A situation doesn't rely on the dice landing the right way and doesn't require any particular order of events. Most importantly, is immune to the fatal knife through the heart of your idea that occurs any time the phrase "*and then the players will* \_\_\_\_" appears in your notes, which all but guarantees your players will do anything *but* what you expected. By establishing the facts of the situation and then working outwards from those facts, you gain the ability to *respond* to the players, build in the direction they're already moving, and have an answer ready to *any* action they take, no matter how insane or out of left field.
...
This applies to your NPCs just as much as it does to the player characters, but it's worth remembering as more than just "the loop also works for NPC action." Everybody wants something - from the archvillain who wants to conquer the world to the stormtrooper who wants an excuse to crack some skulls to the wilderness explorer who wants to find a safe place to shelter for the night to the barista who just wants their shift to be over already and to never have to make another venti soy pumpkin spice latte with extra splenda and foam art in the shape of a trout again in their life. NPC goals are the pull to your players' push, and neither work well without the other to press against. Drama emerges largely in the places where multiple characters' goals push against each other, against the world, or against themselves.
...
> There are some notable exceptions to the guidance about not defaulting to incompetence to explain failure - primarily, genre space where PC incompetence is the point of the game. If the intended tone of your game is comedic and farcical, or otherwise operating with the shared understanding that characters getting in over their heads and screwing up royally is the primary appeal and driver of the drama, then by all means, go nuts and and have fun with it.
...
Blades In The Dark, which popularized the concept, suggests using clocks with no less than 4 and no more than 12 segments, with 8 as the go-to if you need to just pick a number and move on. Blades makes heavy use of clocks for many of its systems, but the most common and most relevant rules are:
...
## Difficulty
#TODO multiple types of difficulty that have nothing to do with each other. Setting difficulty numbers and opposition targets is a system-dependent GM-facing math problem - how often should the players be succeeding or failing? Other type is fictional difficulty - how many obstacles are standing between the players and their goal? These are separate faders. You can have a scenario with very high mechanical difficulty and relatively low fictional difficulty (e.g. a gladiator fight where all you need to do is sign up and win). Or, you can have the opposite, a situation with little mechanical challenge that still requires extensive problem-solving and the completion of multiple steps to achieve the players' goal (e.g. riddles, puzzles, going to the DMV.)
